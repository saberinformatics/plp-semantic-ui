...
## Note on Widgets
It's possible to create widgets for other webservers (e.g. [Sisense Prism](https://documentationv7.sisense.com/v5/elasticube-manager/introduction-to-elasticube-manager/)) using Pipeline Pilot. See our other project [sisense-pipelinepilot](https://github.com/saberinformatics/sisense-pipelinepilot) here on GitHub.
